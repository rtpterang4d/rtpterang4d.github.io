...
function show_popup(data, percent, random_1, random_2, random_3, random_4) {
  ...
  if (percent < 30) {
    ...
    tips_type_number_1 = tips_type_number_1.replaceAll("❎", "").replaceAll("✅", "");
    tips_type_number_2 = tips_type_number_2.replaceAll("❎", "").replaceAll("✅", "");
    tips_type_number_3 = tips_type_number_3.replaceAll("❎", "").replaceAll("✅", "");
    tips_type_number_4 = tips_type_number_4.replaceAll("❎", "").replaceAll("✅", "");
